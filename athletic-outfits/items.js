/**
 * Generated page data for /athletic-outfits.
...
const LOOKS = [
  {
    ...
    "description": "The sporty pieces that anchor an easy athletic outfit.",
    "items": [
      {
        "id": 1,
  ...
  },
  {
    ...
    "description": "Sneakers, socks, bags, and accessories that make the outfit feel styled.",
    "items": [
      {
        "id": 1,
