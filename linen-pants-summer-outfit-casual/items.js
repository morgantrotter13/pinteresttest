/**
 * Generated page data for /linen-pants-summer-outfit-casual.
...
const COLLECTION = {
  ...
  "lead": "A casual summer outfit idea built around breezy white linen-style pants, a crochet swim cover-up, and relaxed striped drawstring pants — easy with a simple top, swimwear, raffia accessories, or as part of a neutral warm-weather capsule.",
  "shopHeading": "Shop the Linen Pants Outfit",
  "shopSubheading": "Start with white wide leg pants, then add neutral tops and summer accessories"
};
...
const LOOKS = [
  {
    ...
    "description": "The breezy pants that anchor this casual summer outfit idea.",
    "items": [
      {
        "id": 1,
  ...
  },
  {
    ...
    "description": "Current tops and accessories that work with the linen pants palette.",
    "items": [
      {
        "id": 1,
