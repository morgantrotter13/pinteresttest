/**
 * Generated page data for /mix-and-match-summer-outfits.
...
const COLLECTION = {
  ...
  "lead": "A summer outfit edit built around rewearing pieces different ways — matching sets, separates, and accessories that can rotate through vacation days, errands, brunch, and casual nights out.",
  "shopHeading": "Shop Mix & Match Pieces",
  "shopSubheading": "Start with a set or separate, then add accessories to create more outfits"
};
...
const LOOKS = [
  ...
  },
  {
    ...
    "description": "Neutral pieces that make each outfit feel more styled without changing the palette.",
    "items": [
      {
        "id": 1,
